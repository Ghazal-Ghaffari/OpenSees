# Minimal Steel01 a1 sensitivity probe
wipe
...
# DDM sensitivity setup for Steel01 parameter a1
reliability
parameter 1 element 1 a1
...
# Read final displacement and its DDM sensitivity to a1
set u [nodeDisp 2 1]
